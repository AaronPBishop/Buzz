...
def seed_users():
    users = [
        {"user_name": 'funkycoder', "first_name": 'Johnny', "last_name": 'Saget',  "email": 'johnnysaget@aa.io', "bio": "funkycoder",
        ...
        {"user_name": 'bobbie', "first_name": 'Bobbie', "last_name": 'Break', "email": 'bobbie@aa.io', "bio": "demo_user3", "profile_img": "https://images.unsplash.com/photo-1507003211169-0a1dd722`8f2d?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=774&q=80",
            "password": 'password2'}, 
        {"user_name": "gerley0", "first_name": "Geordie", "last_name": "Erley", "email": "gerley0@wufoo.com", "bio": "demo_user4", "profile_img": "http://dummyimage.com/236x100.png/5fa2dd/ffffff", "password": "NhacnPmLY"}, 
        {"user_name": "gmomford1", "first_name": "Gabi", "last_name": "Momford", "email": "gmomford1@furl.net", "bio": "demo_user5", "profile_img": "http://dummyimage.com/142x100.png/ff4444/ffffff", "password": "ji4YAqKidx"},
        ...
        {"user_name": "BuzzBoy", "first_name": "Buzzy", "last_name": "Bee", "email": "buzzybee@buzz.com", "bio": "Buzz buzz!", "profile_img": "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ8EPI4S30uTREr-N4DXz14iQNyFA3lhf5DDg&usqp=CAU", "password": "password"}]
