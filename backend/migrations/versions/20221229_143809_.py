...
Revision ID: 6a00899eea53
Revises: 
Create Date: 2022-12-29 14:38:09.134771
...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['organizations'], ['organizations.id'], ),
    sa.ForeignKeyConstraint(['users'], ['users.id'], ),
    sa.PrimaryKeyConstraint('users', 'organizations')
    )
